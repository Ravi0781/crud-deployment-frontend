...
function EditStudent(){
    ...
    useEffect(()=>{
        Axios.get("https://crud-deployment-backend-n4ss.onrender.com/studentRoutes/update-student/" + id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () =>{
        ...
        Axios.put("https://crud-deployment-backend-n4ss.onrender.com/studentRoutes/update-student/" + id, data)
        .then((res) => {
